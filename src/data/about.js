// ============================================================================
//  ABOUT — Applied Association About Content
// ============================================================================
//
...
export const ABOUT = {
  ...
  paragraphs: [
    "The Applied Association is a dedicated support system for students of the Applied Electronics and Instrumentation (AEI) department at College of Engineering Trivandrum. We exist to bridge the gap between students and the department, ensuring that every student has access to timely information, resources, and a platform to voice their concerns.",

    "The association ensures that important notices, event announcements, academic resources, and downloadable materials are available in one central, easy-to-access location. Whether you're looking for the latest exam schedule, lab manuals, event registrations, or need to submit a grievance, the Applied Association is here to help.",
  ...
  milestones: [
    {
      ...
      description: "Applied Association established as a bridge between students and department.",
    },
    {
      year: "2021",
      title: "Went Digital",
